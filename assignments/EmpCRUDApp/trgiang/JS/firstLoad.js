...
const addEmpBtn = document.getElementById('addBtn');
const updateEmpBtn = document.getElementById('updateBtn');
const deleteEmpBtn = document.getElementById('deleteBtn');
const searchEmpBtn = document.getElementById('searchBtn');
...
function renderOpeningCard() {
    var firstLoad = document.getElementById('screen');

    firstLoad.innerHTML = `<style>
    body
       {
